    ...
    function alltrans(data) {
        ...
        data.forEach(e => {
            ...
            `<tr id="header${e.uuid}" class="border-b dark:border-gray-700" onclick="togle('#id${e.uuid}')">
                                                    ...
                                                    <td class="px-4 py-3 uppercase">${ e.useronplan.name}</td>
                                                    <td class="px-4 py-3" ">$${ e.amounttobeadd}</td>
                                                    <td class="px-4 py-3">${e.date}</td>
                                                    <td class="px-4 py-3">${e.off ? "Approved" : "PENDING.."}</td>
